                ...
                ['UI/UX', 'Firebase', 'Next JS', 'React JS', 'Full Stack App', 'All'].map((item, index) => (
                    <div
                        ...
                        className={`app__work-filter-item app__flex p-text py-2 px-4 rounded-lg bg-color font-bold cursor-pointer transition-all duration-300 ease-linear m-2 border border-transparent
                         ...
                         flex justify-center items-center text-sm text-left leading-normal text-[#6b7688] ${activeFilter === item && 'bg-gradient-to-r from-blue-500 via-purple-600 to-red-500 text-transparent bg-clip-text !border-neutral-500 rounded-lg shadow-md '}`}
                    >
                        {item}
                    </div>
                ))
