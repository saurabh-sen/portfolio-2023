...
const ChallengeCard = ({ heading, difficulty, codeLink, liveLink, authorName, authorLink }: PropsChallengeCard) => {
    ...
    return (
        ...
        className={`w-72 rounded-md flex flex-col p-4 gap-2 border ${difficultyColors[difficulty]} shadow-sm hover:shadow-md bg-color`}>
            ...
            <p className="author text-sm flex justify-between items-center ">
